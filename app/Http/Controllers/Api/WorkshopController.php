...
class WorkshopController extends Controller
{
    ...
    public function analyze(Request $request): JsonResponse
    {
        ...
        $prompt = "You are 師父 (Shifu), the expert Chinese language tutor for the Living Lexicon 流動. "
            ...
            . "VOICE — describe what each word DOES in the sentence; do not name POS classes (verb / noun / stative / etc.). "
            . "✓ '等不了 — can't wait (inability to wait, not impatience)' "
            . "✗ '等不了 — stative-transitive verb meaning unable to wait.'\n\n"
            . "LENS-AWARE NOTES — when a word fits one of these cohorts, frame the note around what the form does:\n"
            . "- Inhabited-mode states (忍, 愛, 信, 知, 教 jiao4, 受得了, 算了, 等不了): describe as a sustained mode, not a discrete event. "
            . "'inability to wait, not impatience' is the right shape.\n"
            . "- Potential-complement forms (V+得/不+結 — 受得了, 想不到, 找得到, 看不出, 等不了): note the modal force of 得/不 ('can/cannot'); "
            . "for the 了-cohort, the 了 is the verb 了 (manage through), not the perfective particle.\n"
            . "- Relational-causality verbs (嚇, 吸引, 感動, 引起): note that the source is the subject and the experiencer is the object — the geometry English-trained learners often miss.\n\n"
