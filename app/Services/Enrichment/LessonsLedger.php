...
class LessonsLedger
{
    ...
    private static array $lessons = [
        ...
        [
            ...
            'correct'     => 'Apply the two-stage decision to EVERY sense. STAGE 1: Does this sense denote a quality with a strength gradient? If NO → intensity: 0 (Not Applicable) + _flags note naming why (concrete noun / function word / measure word / etc.). STOP. If YES → continue. STAGE 2 (only when Stage 1 = YES): Grade on the 1-5 scale. Cross-POS calibration: 愛好/很/好/熱情/喊 all sit at 3 (moderate, present-but-not-extreme) — force level feels equivalent across POS. Every submitted sense MUST have 0 or 1-5; null is a VALIDATOR BLOCKER (R22). Not Applicable (intensity: 0) is a first-class editorial choice with the same dignity as picking 3. Full spec: memory/project_intensity_specification.md.',
        ],
    ];
