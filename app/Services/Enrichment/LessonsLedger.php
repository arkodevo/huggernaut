...
class LessonsLedger
{
    ...
    private static array $lessons = [
        ...
        [
            ...
            'category'    => 'definition_quality',
            'title'       => 'Intensity defaulted to 1; Not Applicable not used; null left on enriched senses',
            'seen_in'     => ['Pre-2026-04-19 DB state (5,599 senses at intensity=1, 2,353 at null out of ~7,600 total)'],
            'description' => 'Intensity has three distinct storage states: 0 = Not Applicable (explicit editorial decision, word has no strength gradient), 1-5 = Graded intensity, null = Not yet enriched (pending). Prior framing ("1-5 or null") collapsed these — null felt like an empty field, so enrichers reflexively wrote 1 as the unconscious default. The 5,599 senses at intensity=1 and the 2,353 senses at null are two distinct retrospective debts: the first needs re-grading (decisions were made poorly); the second needs initial enrichment (no decision was made at all). Concrete nouns like 桌子 ended up at 1 when Stage 1 should have answered 0 (Not Applicable).',
            'example'     => 'Prior state: 愛 at intensity=1 alongside 熱愛 at 1 alongside 痴迷 at 1 — pedagogically broken, no distinction made. Concrete nouns at intensity=1 when they should be 0. Cross-POS: 很 (Adv "very") and 有點 (Adv "a bit") shouldn\'t sit at the same level. · Canonical Like-Love family now (positive valence held across 1-5): 1=心動/有好感 (first stirring), 2=喜歡 (baseline like), 3=愛好 (established fondness), 4=愛 (committed bond), 5=熱愛 (passionate love). 痴迷 is excluded from this family because it shifts connotation to negative-dominant at level 5 — a linguistic pattern worth noting: extreme intensity often co-varies with valence shift. Grade intensity and connotation independently.',
            'correct'     => 'v2.2 categorical rule: Stage 1 is answered by POS category, NOT per-word judgment. ONLY these POS get graded 1-5: Vs (stative intransitive), Vst (state-transitive), degree adverbs (有點/比較/很/非常/極其), abstract emotional/evaluative N (熱情/恐懼), IE (idioms with built-in weight). EVERYTHING ELSE → intensity: 0 (Not Applicable). This includes all action verbs (V, Vi, Vpt, Vsep, Vp, Vpsep, Vssep), Vaux/Vcomp, Vsattr, all concrete nouns, all function words, non-degree adverbs (已經, 正在, 暗中). STAGE 2 (only for graded categories): Grade 1-5. Cross-POS calibration: 愛好/很/好/熱情 all sit at 3. Every submitted sense MUST have 0 or 1-5; null is a VALIDATOR BLOCKER (R22). Worked examples: 痴迷 (Vst) → intensity 5 + connotation negative-dominant (independent fields). 暴力 Vs → intensity 4 + connotation negative-dominant. 報仇 (Vsep) → intensity 0 (action verb). 桌子 (N) → intensity 0 (concrete). Full spec: memory/project_intensity_specification.md §4.0a.',
        ],
    ];
